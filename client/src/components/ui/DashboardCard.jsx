export default function DashboardCard({ title, value, description, badge, children }) {
  return (
    <article className="surface-card surface-glow overflow-hidden p-6 transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_30px_70px_rgba(2,6,23,0.5)]">
