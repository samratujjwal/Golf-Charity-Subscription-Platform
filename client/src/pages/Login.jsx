...
export default function Login() {
  ...
  return (
    <section className="mx-auto max-w-xl surface-card p-8">
      ...
      <p className="section-copy">Access your billing, dashboard, and protected member workspace.</p>
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        ...
        <label className="block">
          ...
          <InputField type="password" name="password" value={form.password} onChange={handleChange} placeholder="Enter your password" required />
        </label>
